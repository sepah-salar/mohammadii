...
<div class="container mt-5">
    <h1 class="text-center">مشخصات اکانت</h1>
    <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body" dir="rtl">
                            ...
                            <?php if(isset($_SESSION['username']) && $_SESSION['username'] === 'ghalesefid'): ?>
                                <a href="news_edit_action.php?id=<?php echo((int)$row['id'])?>" class="btn btn-warning">✏ ویرایش</a>
                                <form action="news_delete.php?id=<?php echo((int)$row['id'])?>" method="post" style="display: inline;">
